    ...
    try {
        ...
        const users = await userRepository.save([
            ...
            },
            {
                ...
                firstName: 'Sarah',
                lastName: 'Johnson',
                role: user_entity_1.UserRole.FRONT_DESK,
                phone: '+1234567891',
                isActive: true,
            },
            {
        ...
        const doctors = await doctorRepository.save([
            {
                ...
                gender: doctor_entity_1.DoctorGender.MALE,
                location: 'Room 101',
            ...
            },
            {
                ...
                gender: doctor_entity_1.DoctorGender.FEMALE,
                location: 'Room 102',
        ...
        const appointmentRepository = AppDataSource.getRepository(appointment_entity_1.Appointment);
        ...
        const queueRepository = AppDataSource.getRepository(queue_item_entity_1.QueueItem);
        const queueItems = await queueRepository.save([
            {
                ...
                priority: queue_item_entity_1.QueuePriority.NORMAL,
            ...
            },
            {
                ...
                patientAge: 32,
                status: queue_item_entity_1.QueueStatus.CALLED,
                priority: queue_item_entity_1.QueuePriority.HIGH,
                reason: 'Urgent care',
